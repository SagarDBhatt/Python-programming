...
# Input Format
#
# A single line containing the complex number . Note: complex() function can be used in python to convert the input
# as a complex number.
#
# Constraints
#
...
rad = math.sqrt(pow(real, 2) + pow(complexNumber.imag, 2))
# print(rad)

phs = cmath.phase(complexNumber)
